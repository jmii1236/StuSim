...
const PERSONA_INSTRUCTIONS = {
    mobolaji: [
        ...
        'Do NOT describe your actual actions, do NOT use special characters like asterisks, or non-verbal symbols (|, &, (), ->, etc). Only use periods.',
        'No roleplaying actions. Respond as if you are talking or speaking to someone. Do not write inner-thoughts or non-vocalized sentences.',
